"""
Training script for HLS L30 PSETAE model
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor', default='HLS_L30', type=str,
                        help='Type of mission data to train e.g.HLS_L30')
    parser.add_argument('--minimum_sampling', default=16, type=int,
                        help='minimum time series length to sample for HLS_L30')
    ...
    parser.add_argument('--gamma', default=1.0, type=float, help='Gamma parameter of the focal loss')
    parser.add_argument('--npixel', default=16, type=int, help='Number of pixels to sample from the input images')

    # Architecture Hyperparameters
    ## PSE
    parser.add_argument('--input_dim', default=8, type=int, help='Number of channels of input images')
    parser.add_argument('--mlp1', default='[8,32,64]', type=str, help='Number of neurons in the layers of MLP1')
