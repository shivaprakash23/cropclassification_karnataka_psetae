...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='D:/Semester4/ProjectVijayapur/psetae/psetae_all5models/5_sentinel_s1_s2_fusion/multi_sensor/inference/inferencing_models/tae/s1_s2_results_tae_seed87/model.pth.tar',
    ...
    parser.add_argument('--fusion_type', type=str, default='tsa',
                        help='Type of fusion to use (e.g., tsa)')
    ...
    parser.add_argument('--output_dir', type=str, 
                        default='D:/Semester4/ProjectVijayapur/psetae/psetae_all5models/5_sentinel_s1_s2_fusion/multi_sensor/inference/inference_results_tae',
