...
class InferenceFusion:
    ...
    def plot_confusion_matrix(self, conf_mat, save_path):
        ...
        plt.xlabel('Predicted Label (0-9)', labelpad=10)
        plt.ylabel('True Label (0-9)', labelpad=10)
...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='D:/Semester4/ProjectVijayapur/psetae/psetae_all5models/5_sentinel_s1_s2_fusion/multi_sensor/inference/inferencing_models/pse/s1_s2_results_pse_seed50/model.pth.tar',
    ...
    parser.add_argument('--fusion_type', type=str, default='pse',
                        help='Type of fusion to use (e.g., pse, softmax_avg, tsa, early, softmax_norm, softmax_learnable)')
    parser.add_argument('--num_classes', type=int, default=10,
                        help='Number of classes in the dataset')
    parser.add_argument('--npixel', type=int, default=64,
                        help='Number of pixels to sample from each parcel')
    parser.add_argument('--minimum_sampling', type=int, default=16,
    ...
    parser.add_argument('--output_dir', type=str, 
                        default='D:/Semester4/ProjectVijayapur/psetae/psetae_all5models/5_sentinel_s1_s2_fusion/multi_sensor/inference/inference_results_pse',
    ...
    model_config = {
        ...
        'mlp1': [10, 32, 64],  # First dimension must match input_dim
        'pooling': 'mean_std',
        'mlp2': [128, 128],
        'geomfeat': 0,
        'n_head': 4,
        'd_k': 32,
        'mlp3': [512, 128, 128],  # For tsa and softmax fusions
        'T': 366,
        'positions': 'order',
        'lms': 210,  # len_max_seq parameter
        'dropout': 0.2,
        'mlp4': [128, 64, 32, 10]  # Last dimension must match num_classes
    }
